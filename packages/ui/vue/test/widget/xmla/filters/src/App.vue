...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <FiltersWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        FiltersWidget Settings
      </h2>
      <FiltersWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import FiltersWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.xmla.filters/src/FiltersWidget.vue'
import FiltersWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.xmla.filters/src/FiltersWidgetSettings.vue'
