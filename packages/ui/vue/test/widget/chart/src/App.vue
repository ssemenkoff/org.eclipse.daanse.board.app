...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <ChartWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <ChartWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import ChartWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.chart/src/ChartWidget.vue'
import ChartWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.chart/src/ChartWidgetSettings.vue'
