...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <SvgWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <SvgWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import SvgWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.svg.base/src/SvgWidget.vue'
import SvgWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.svg.base/src/SvgWidgetSettings.vue'
