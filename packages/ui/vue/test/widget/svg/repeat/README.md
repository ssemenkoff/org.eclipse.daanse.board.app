# RepeatableSvgWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.svg.repeat`, modeled on the
...
```bash
cd packages/ui/vue/test/widget/svg/repeat
yarn install
