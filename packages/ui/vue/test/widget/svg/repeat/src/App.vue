...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <RepeatableSvgWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        RepeatableSvgWidget Settings
      </h2>
      <RepeatableSvgWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import RepeatableSvgWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.svg.repeat/src/RepeatableSvgWidget.vue'
import RepeatableSvgWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.svg.repeat/src/RepeatableSvgWidgetSettings.vue'
