...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <CodeWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <CodeWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import CodeWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.code/src/CodeWidget.vue'
import CodeWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.code/src/CodeWidgetSettings.vue'
