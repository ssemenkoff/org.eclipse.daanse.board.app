...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <VantaWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        VantaWidget Settings
      </h2>
      <VantaWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import VantaWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.vanta/src/VantaWidget.vue'
import VantaWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.vanta/src/VantaWidgetSettings.vue'
