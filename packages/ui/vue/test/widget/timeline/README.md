# TimelineWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.timeline`, modeled on the
...
|  (TimelineWidget) |  (TimelineWidgetSettings) |
+-----------------------------------------------+
```
...
```bash
cd packages/ui/vue/test/widget/timeline
yarn install
