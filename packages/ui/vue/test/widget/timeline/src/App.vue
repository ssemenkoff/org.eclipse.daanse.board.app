...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <TimelineWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        TimelineWidget Settings
      </h2>
      <TimelineWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import TimelineWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.timeline/src/TimelineWidget.vue'
import TimelineWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.timeline/src/TimelineWidgetSettings.vue'
