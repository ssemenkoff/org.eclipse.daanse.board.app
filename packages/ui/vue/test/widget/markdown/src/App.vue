...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <MarkdownWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        MarkdownWidget Settings
      </h2>
      <MarkdownWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import MarkdownWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.markdown/src/MarkdownWidget.vue'
import MarkdownWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.markdown/src/MarkdownWidgetSettings.vue'
