...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <IconWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <IconWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import IconWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.icon/src/IconWidget.vue'
import IconWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.icon/src/IconWidgetSettings.vue'
