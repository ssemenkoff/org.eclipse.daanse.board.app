# SampleWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.sample`, modeled on the
...
```bash
cd packages/ui/vue/test/widget/sample
yarn install
