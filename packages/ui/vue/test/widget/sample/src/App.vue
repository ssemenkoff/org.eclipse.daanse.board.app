...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <SampleWidget :datasourceId="datasourceId" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <SampleWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import SampleWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.sample/src/SampleWidget.vue'
import SampleWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.sample/src/SampleWidgetSettings.vue'
