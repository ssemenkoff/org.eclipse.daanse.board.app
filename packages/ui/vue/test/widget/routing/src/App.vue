...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <RoutingWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        RoutingWidget Settings
      </h2>
      <RoutingWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import RoutingWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.routing/src/RoutingWidget.vue'
import RoutingWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.routing/src/RoutingWidgetSettings.vue'
