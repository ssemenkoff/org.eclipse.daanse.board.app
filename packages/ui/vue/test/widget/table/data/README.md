# DataTableWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.table.data`, modeled on the
...
|  (DataTableWidget) |  (DataTableWidgetSettings) |
+-----------------------------------------------+
```
...
```bash
cd packages/ui/vue/test/widget/table/data
yarn install
