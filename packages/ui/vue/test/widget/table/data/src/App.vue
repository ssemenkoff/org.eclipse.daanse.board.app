...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <DataTableWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        DataTableWidget Settings
      </h2>
      <DataTableWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import DataTableWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.table.data/src/DataTableWidget.vue'
import DataTableWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.table.data/src/DataTableWidgetSettings.vue'
