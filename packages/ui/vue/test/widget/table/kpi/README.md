# KpiTableWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.table.kpi`, modeled on the
...
|  (KpiTableWidget) |  (KpiTableWidgetSettings) |
+-----------------------------------------------+
```
...
```bash
cd packages/ui/vue/test/widget/table/kpi
yarn install
