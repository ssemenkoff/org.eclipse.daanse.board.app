...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <KpiTableWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        KpiTableWidget Settings
      </h2>
      <KpiTableWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import KpiTableWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.table.kpi/src/KpiTableWidget.vue'
import KpiTableWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.table.kpi/src/KpiTableWidgetSettings.vue'
