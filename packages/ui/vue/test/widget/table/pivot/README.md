# PivotTableWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.table.pivot`, modeled on the
...
|  (PivotTableWidget) |  (PivotTableWidgetSettings) |
+-----------------------------------------------+
```
...
```bash
cd packages/ui/vue/test/widget/table/pivot
yarn install
