...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <ImageWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        ImageWidget Settings
      </h2>
      <ImageWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import ImageWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.image/src/ImageWidget.vue'
import ImageWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.image/src/ImageWidgetSettings.vue'
