...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <RssWidget :datasourceId="datasourceId" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <RssWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import RssWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.rss/src/RssWidget.vue'
import RssWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.rss/src/RssWidgetSettings.vue'
