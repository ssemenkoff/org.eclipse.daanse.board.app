# RssWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.rss`, modeled on the
...
```bash
cd packages/ui/vue/test/widget/rss
yarn install
