# WeatherWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.weather`, modeled on the
...
|  (WeatherWidget) |  (WeatherWidgetSettings) |
+-----------------------------------------------+
```
...
```bash
cd packages/ui/vue/test/widget/weather
yarn install
