...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <WeatherWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <WeatherWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import WeatherWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.weather/src/WeatherWidget.vue'
import WeatherWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.weather/src/WeatherWidgetSettings.vue'
