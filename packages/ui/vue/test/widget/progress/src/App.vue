...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <ProgressWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        ProgressWidget Settings
      </h2>
      <ProgressWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import ProgressWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.progress/src/ProgressWidget.vue'
import ProgressWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.progress/src/ProgressWidgetSettings.vue'
