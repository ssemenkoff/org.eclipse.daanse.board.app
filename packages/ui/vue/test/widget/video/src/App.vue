...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <VideoWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        VideoWidget Settings
      </h2>
      <VideoWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import VideoWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.video/src/VideoWidget.vue'
import VideoWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.video/src/VideoWidgetSettings.vue'
