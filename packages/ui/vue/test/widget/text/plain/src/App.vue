...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <TextWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <TextWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import TextWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.text.plain/src/TextWidget.vue'
import TextWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.text.plain/src/TextWidgetSettings.vue'
