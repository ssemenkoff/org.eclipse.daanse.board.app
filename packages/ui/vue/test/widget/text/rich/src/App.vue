...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <RichTextWidget :datasourceId="datasourceId" :config="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        RichTextWidget Settings
      </h2>
      <RichTextWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import RichTextWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.text.rich/src/RichTextWidget.vue'
import RichTextWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.text.rich/src/RichTextWidgetSettings.vue'
