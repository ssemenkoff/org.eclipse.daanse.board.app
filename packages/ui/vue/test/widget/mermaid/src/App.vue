...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <MermaidWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      <h2 style="margin-bottom: 16px; font-size: 18px; color: #333;">
        MermaidWidget Settings
      </h2>
      <MermaidWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import MermaidWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.mermaid/src/MermaidWidget.vue'
import MermaidWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.mermaid/src/MermaidWidgetSettings.vue'
