...
<template>
  <div style="width: 100vw; height: 100vh; display: flex;">
    ...
    >
      <PageWidget :datasourceId="datasourceId" v-model:configv="config" data-testid="test-widget" />
    </div>
    ...
    >
      ...
      <PageWidgetSettings v-model="config" data-testid="test-settings" />
    </div>
  </div>
</template>
...
import { ref } from 'vue'
import PageWidget from 'org.eclipse.daanse.board.app.ui.vue.widget.page/src/PageWidget.vue'
import PageWidgetSettings from 'org.eclipse.daanse.board.app.ui.vue.widget.page/src/PageWidgetSettings.vue'
