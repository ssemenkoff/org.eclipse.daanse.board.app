# PageWidget Dockyard - E2E Testing

Standalone Vite+Vue harness for end-to-end testing
`org.eclipse.daanse.board.app.ui.vue.widget.page`, modeled on the
...
```bash
cd packages/ui/vue/test/widget/page
yarn install
