...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.vanta', () => {
  it('renders VantaWidget component', () => {
    const wrapper = mount(VantaWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders VantaWidgetSettings component', () => {
    const wrapper = mount(VantaWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
