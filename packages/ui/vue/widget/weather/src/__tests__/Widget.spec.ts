...
import WeatherVantaBackground from '../components/WeatherVantaBackground.vue';
...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.weather', () => {
  it('renders WeatherWidget component', () => {
  ...
  it('renders WeatherWidgetSettings component', () => {
    const wrapper = mount(WeatherWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders ForecastChart component', () => {
  ...
  it('renders WeatherVantaBackground component', () => {
    const wrapper = mount(WeatherVantaBackground, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
