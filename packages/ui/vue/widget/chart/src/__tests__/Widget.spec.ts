...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.chart', () => {
  it('renders ChartWidget component', () => {
  ...
  it('renders ChartWidgetSettings component', () => {
    const wrapper = mount(ChartWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
