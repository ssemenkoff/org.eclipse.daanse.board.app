...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.table.data', () => {
  it('renders DataTableWidget component', () => {
  ...
  it('renders DataTableWidgetSettings component', () => {
    const wrapper = mount(DataTableWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
