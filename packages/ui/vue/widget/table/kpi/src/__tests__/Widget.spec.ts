...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.table.kpi', () => {
  it('renders KpiTableWidget component', () => {
    const wrapper = mount(KpiTableWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders KpiTableWidgetSettings component', () => {
    const wrapper = mount(KpiTableWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
