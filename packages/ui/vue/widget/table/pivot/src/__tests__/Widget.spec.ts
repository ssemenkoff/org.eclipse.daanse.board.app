...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.table.pivot', () => {
  it('renders PivotTableWidget component', () => {
    const wrapper = mount(PivotTableWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders PivotTableWidgetSettings component', () => {
    const wrapper = mount(PivotTableWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
