...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.code', () => {
  it('renders CodeWidget component', () => {
  ...
  it('renders CodeWidgetSettings component', () => {
    const wrapper = mount(CodeWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
