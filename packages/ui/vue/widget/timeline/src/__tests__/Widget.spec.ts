...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.timeline', () => {
  it('renders TimelineWidget component', () => {
  ...
  it('renders TimelineWidgetSettings component', () => {
    const wrapper = mount(TimelineWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
