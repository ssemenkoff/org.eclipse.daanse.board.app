...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.sample', () => {
  it('renders SampleWidget component', () => {
    const wrapper = mount(SampleWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders SampleWidgetSettings component', () => {
    const wrapper = mount(SampleWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
