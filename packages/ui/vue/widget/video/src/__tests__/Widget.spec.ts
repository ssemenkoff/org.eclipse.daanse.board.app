...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.video', () => {
  it('renders VideoWidget component', () => {
  ...
  it('renders VideoWidgetSettings component', () => {
    const wrapper = mount(VideoWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
