...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.text.rich', () => {
  it('renders RichTextWidget component', () => {
    const wrapper = mount(RichTextWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders RichTextWidgetSettings component', () => {
    const wrapper = mount(RichTextWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
