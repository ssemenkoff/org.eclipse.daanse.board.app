...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.text.plain', () => {
  it('renders TextWidget component', () => {
  ...
  it('renders TextWidgetSettings component', () => {
    const wrapper = mount(TextWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
