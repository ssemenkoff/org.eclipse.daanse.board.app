...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.wrapper', () => {
  it('renders WidgetWrapper component', () => {
  ...
  it('renders WidgetWrapperSettings component', () => {
    const wrapper = mount(WidgetWrapperSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
