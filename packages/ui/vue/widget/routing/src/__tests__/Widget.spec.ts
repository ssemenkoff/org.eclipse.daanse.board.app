...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.routing', () => {
  it('renders RoutingWidget component', () => {
    const wrapper = mount(RoutingWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders RoutingWidgetSettings component', () => {
    const wrapper = mount(RoutingWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
