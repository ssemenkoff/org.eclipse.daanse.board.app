...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.progress', () => {
  it('renders ProgressWidget component', () => {
    const wrapper = mount(ProgressWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders ProgressWidgetSettings component', () => {
    const wrapper = mount(ProgressWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
