...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.markdown', () => {
  it('renders MarkdownWidget component', () => {
  ...
  it('renders MarkdownWidgetSettings component', () => {
    const wrapper = mount(MarkdownWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
