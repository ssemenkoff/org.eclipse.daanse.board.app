...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.icon', () => {
  it('renders IconWidget component', () => {
    const wrapper = mount(IconWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders IconWidgetSettings component', () => {
    const wrapper = mount(IconWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
