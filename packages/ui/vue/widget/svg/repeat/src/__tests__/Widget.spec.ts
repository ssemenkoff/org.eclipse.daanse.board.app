...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.svg.repeat', () => {
  it('renders RepeatableSvgWidget component', () => {
    const wrapper = mount(RepeatableSvgWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders RepeatableSvgWidgetSettings component', () => {
    const wrapper = mount(RepeatableSvgWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
