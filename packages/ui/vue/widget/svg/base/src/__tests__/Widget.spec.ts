...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.svg.base', () => {
  it('renders SvgWidget component', () => {
    const wrapper = mount(SvgWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders SvgWidgetSettings component', () => {
    const wrapper = mount(SvgWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
