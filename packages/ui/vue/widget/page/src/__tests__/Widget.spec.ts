...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.page', () => {
  it('renders PageLayoutRenderer component', () => {
    const wrapper = mount(PageLayoutRenderer, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders PageWidget component', () => {
    const wrapper = mount(PageWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders PageWidgetSettings component', () => {
    const wrapper = mount(PageWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
