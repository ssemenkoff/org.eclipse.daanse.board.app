...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.image', () => {
  it('renders ImageWidget component', () => {
  ...
  it('renders ImageWidgetSettings component', () => {
    const wrapper = mount(ImageWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
