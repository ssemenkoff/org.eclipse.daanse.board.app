...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.rss', () => {
  it('renders RssWidget component', () => {
    const wrapper = mount(RssWidget, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
  ...
  it('renders RssWidgetSettings component', () => {
    const wrapper = mount(RssWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
