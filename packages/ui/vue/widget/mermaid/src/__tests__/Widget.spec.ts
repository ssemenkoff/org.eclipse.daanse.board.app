...
describe('Rendering tests for org.eclipse.daanse.board.app.ui.vue.widget.mermaid', () => {
  it('renders MermaidWidget component', () => {
  ...
  it('renders MermaidWidgetSettings component', () => {
    const wrapper = mount(MermaidWidgetSettings, {
      props: {
        datasourceId: 'ds-1',
        dataSourceId: 'ds-1',
        id: 'widget-1',
